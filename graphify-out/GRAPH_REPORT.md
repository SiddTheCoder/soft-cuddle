...
## Corpus Check
- 87 files · ~44,109 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 613 nodes · 713 edges · 50 communities (44 shown, 6 thin omitted)
...
- `teardown()` --calls--> `closeDb()`  [INFERRED]
  packages/db/tests/global-setup.ts → packages/db/client.ts
- `authorize()` --calls--> `recordAudit()`  [EXTRACTED]
  apps/web/lib/auth.ts → apps/web/lib/audit.ts
- `createTotpEnrolment()` --calls--> `encryptSecret()`  [EXTRACTED]
...
Cohesion: 0.05
Nodes (49): Account, accountClass, accounts, normalBalance, Product, productKind, products, Application (+41 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (46): closeDb(), db, DbTx, isNeon, AdminUser, adminUsers, AuditLog, auditLogs (+38 more)
...
Cohesion: 0.11
Nodes (18): 10. Reconciliation targets, 11. Open items for the accountant, 1. Account numbering, 2. Assets, 3. Liabilities, 4. Equity, 5. Revenue, 6. Direct costs (+10 more)
...
- **Why does `products` connect `Community 0` to `Community 1`, `Community 5`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
- **Why does `9. Posting rules` connect `Community 8` to `Community 12`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
- **Why does `Softmato Technology Pvt Ltd — Chart of Accounts & Posting Rules` connect `Community 12` to `Community 8`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
