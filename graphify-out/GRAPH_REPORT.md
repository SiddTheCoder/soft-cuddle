...
## Corpus Check
- 153 files · ~57,667 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 844 nodes · 1302 edges · 59 communities (52 shown, 7 thin omitted)
...
Cohesion: 0.07
Nodes (32): publishContent(), unpublishContent(), saveContent(), ActionResult, databaseMessage(), parseId(), requireAdmin(), requireKind() (+24 more)
...
Cohesion: 0.1
Nodes (24): uploadCmsImage(), UploadResult, cmsObjectKey(), DetectedImage, detectImage(), ImageMime, Signature, SIGNATURES (+16 more)

### Community 10 - "Community 10"
Cohesion: 0.1
Nodes (23): Added, Added, Added, Added, Added, Added, Changelog, code:markdown (## [Phase N] — YYYY-MM-DD) (+15 more)

### Community 11 - "Community 11"
Cohesion: 0.14
Nodes (16): robots(), siteUrl(), ContactResult, schema, submitContact(), ContactNotification, notifyContact(), hashIp() (+8 more)
...
## Knowledge Gaps
- **361 isolated node(s):** `eslintConfig`, `Surface`, `SUBDOMAIN_SURFACE`, `SURFACE_PREFIX`, `config` (+356 more)
...
- **Why does `submitContact()` connect `Community 11` to `Community 2`, `Community 13`?**
  _High betweenness centrality (0.116) - this node is a cross-community bridge._
- **Why does `headers` connect `Community 13` to `Community 11`?**
