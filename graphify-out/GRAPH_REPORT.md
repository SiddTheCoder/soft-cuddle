...
## Corpus Check
- 148 files · ~55,389 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 807 nodes · 1235 edges · 58 communities (52 shown, 6 thin omitted)
...
2. `getPage()` - 20 edges
3. `[Phase 1] — 2026-08-14` - 15 edges
4. `Design` - 14 edges
5. `published()` - 13 edges
6. `Coding Standards` - 13 edges
7. `Softmato Technology Pvt Ltd — Chart of Accounts & Posting Rules` - 12 edges
8. `Testing` - 12 edges
9. `products` - 11 edges
10. `9. Posting rules` - 11 edges
...
Cohesion: 0.09
Nodes (42): generateMetadata(), sitemap(), BlogIndexPage(), generateMetadata(), generateMetadata(), metadataFor(), getLegalDocument(), getPage() (+34 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (51): closeDb(), db, DbTx, isNeon, AdminUser, adminUsers, AuditLog, auditLogs (+43 more)

### Community 2 - "Community 2"
Cohesion: 0.07
Nodes (31): publishContent(), unpublishContent(), saveContent(), ActionResult, databaseMessage(), parseId(), requireAdmin(), requireKind() (+23 more)
...
Cohesion: 0.11
Nodes (20): Added, Added, Added, Added, Added, Changelog, code:markdown (## [Phase N] — YYYY-MM-DD), Entry template (+12 more)
...
Cohesion: 0.17
Nodes (13): robots(), siteUrl(), ContactResult, schema, submitContact(), ContactNotification, notifyContact(), hashIp() (+5 more)
...
Cohesion: 0.14
Nodes (12): FiscalPeriod, fiscalPeriods, periodStatus, entryDirection, JournalEntry, journalSource, LedgerEntry, NewJournalEntry (+4 more)
...
Cohesion: 0.19
Nodes (10): products, journalEntries, ledgerEntries, ProductSeed, productSeeds, headers, insertJournal(), leaves (+2 more)
...
Cohesion: 0.36
Nodes (4): listPublishedLegalDocuments(), SiteFooter(), LINKS, SiteHeader()
...
Cohesion: 0.33
Nodes (3): accounts, AccountSeed, accountSeeds
...
## Knowledge Gaps
- **338 isolated node(s):** `eslintConfig`, `Surface`, `SUBDOMAIN_SURFACE`, `SURFACE_PREFIX`, `config` (+333 more)
...
- **Why does `submitContact()` connect `Community 12` to `Community 25`, `Community 2`?**
  _High betweenness centrality (0.110) - this node is a cross-community bridge._
- **Why does `headers` connect `Community 25` to `Community 12`?**
